...
The idea behind is to make it easy to develop and style widget using React ecosystem, in the end together with developer bring editor good user experience for page editing.
