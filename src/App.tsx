...
function App() {
  ...
  },
  {
    ...
    content: {
      layout: {},
      data:  "<p>Purna Sen's comments follow a BBC investigation which revealed the sackings of a number of UN staff who tried to expose alleged wrongdoing. </p><p>Ms Sen said the UN should \"step up\" and adopt any suggestions made by a panel. </p>  The UN has said it is committed to protecting \"bona fide whistleblowers\" and holding staff accountable.    </p><p>   The BBC documentary, The Whistleblowers: Inside the UN, features accounts from staff members who tried to report allegations - including fraud and sexual abuse. All said they had been penalised after speaking out - and some were sacked.</p>"      
    }
  }
  ];
