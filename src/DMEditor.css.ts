...
export const dmeditorEditCss = css`
  ...
  --dme-container-width: calc(
    100vw - 2px - var(--dme-layout-tool-width) - var(--dme-layout-property-width)
  );
  ...
  display: grid;
  grid-template-columns: var(--dme-layout-tool-width) var(--dme-container-width) var(
  ...
  .viewmode-edit {
    ...
    .dme-block-container.active .inblock.dme-block-container:hover,
    .viewmode-edit .active.inblock {
      outline: 1px dashed #00721f !important;
      outline-offset: 1px;
    }
  }

  .layout-main.viewmode-pc,
  .layout-main.viewmode-edit {
  ...
  *[contenteditable='true']:empty::before {
  ...
  .tab-header .btn,
  .tab-header.normal:last-child .btn {
    color: rgba(0, 0, 0, 0.6);
  }

  .tab-header.current .btn,
  .tab-header:last-child .btn {
    color: #12913e;
  }
