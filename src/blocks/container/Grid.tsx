...
export const ContainerGrid = (props:any)=>{
  ...
  useEffect(()=>{
   if(isChange){
    props.onChange({...props.data,children:children,settings:{columns:columns,common: commonSettings}});
    setIsChange(false)
   }
  },[isChange])
  ...
  return (
    <>
       {props.active&&<BlockProperty  blocktype="container_grid" inBlock={props.inBlock}>
        ...
        <div style={commonSettings} className={getCommonBlockCss('container_grid')}>
