...
import { PropertyTab } from '../components/PropertyTab/Tab';
import { MenuList } from '../components/widget/MenuList/MenuList';
import {
  BrowseProps,
  DeviceType,
  isServer,
          ...
          <div className={viewmode == 'edit' ? 'layout-left-menu' : 'layout-left-menu view'}>
            ...
            >
              <Tooltip title={t('Edit')} arrow placement="right">
                <a
                  href="/"
                  className={viewmode == 'edit' ? 'current' : ''}
                  onClick={(e) => {
                    onChangeViewMode(e, 'edit');
                  }}
                >
                  <ModeEditOutline />
                </a>
              ...
              <Tooltip title={t('Desktop')} arrow placement="right">
                <a
                  href="/"
                  className={viewmode == 'pc' ? 'current' : ''}
                  onClick={(e) => {
                    onChangeViewMode(e, 'pc');
                  }}
                >
                  <LaptopMacOutlined />
                </a>
              ...
              <Tooltip title={t('Mobile')} arrow placement="right">
                <a
                  href="/"
                  className={viewmode == 'mobile' ? 'current' : ''}
                  onClick={(e) => {
                    onChangeViewMode(e, 'mobile');
                  }}
                >
                  {' '}
                  <PhoneIphoneOutlined />
              ...
              <Tooltip title={t('Tablet')} arrow placement="right">
                <a
                  href="/"
                  className={viewmode == 'tablet' ? 'current' : ''}
                  onClick={(e) => {
                    onChangeViewMode(e, 'tablet');
                  }}
                >
                  <TabletMacOutlined />
                </a>
              ...
              <Tooltip title={t('Settings')} arrow placement="right">
                <a
                  href="/"
                  className={settingsShown ? 'current' : ''}
